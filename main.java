public class main {
	...
	public static void main(String[] args) {
		...
		mahasiswa.setNama ("AHMAD MUJAENI");
		mahasiswa.setNim ("D0217509");
		mahasiswa.setAlamat ("LIPU");
		mahasiswa.setGolongandarah ("A");
		mahasiswa.setStatus ("pelajar");
		mahasiswa.setTinggibadan (160);
		mahasiswa.setBeratbadan (45);
